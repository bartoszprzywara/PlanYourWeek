    ...
    public class LocalDatabaseHelper
    {
        ...
        public static void InitializeLocalDB()
        {
            if (!File.Exists(sqlpath))
            {
                ...
                InsertItem(new Activity("Zmierzyć ile trzeba płytek", "Kuchnia i łazienka", 3, true, "Najblizsze", null, null, new DateTime(2016, month + 1, 18), null, 2, 4, 3));
                InsertItem(new Activity("Kupić okna", "", 3, true, "Najblizsze", null, null, new DateTime(2016, month + 2, 06), null, 6, 1, 4));
                InsertItem(new Activity("Poszukać ekipy do wymiany okien", "Takiej, która zrobi to najszybciej", 3, true, "Najblizsze", null, null, new DateTime(2016, month + 1, 06), null, 3, 5, 4));
                InsertItem(new Activity("Przesunąć lampę na suficie", "Bliżej aneksu", 2, true, "Najblizsze", null, null, null, null, 4, 9, null));
                InsertItem(new Activity("Powiesić szafkę w łazience", "Nad pralką", 1, true, "Najblizsze", null, null, new DateTime(2016, month + 1, 15), null, 3, 7, null));
