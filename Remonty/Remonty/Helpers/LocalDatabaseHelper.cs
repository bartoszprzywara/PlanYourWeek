...
namespace Remonty.Helpers
{
    public class LocalDatabaseHelper
    {
        ...
        private static readonly SQLite.Net.SQLiteConnection conn = new SQLite.Net.SQLiteConnection(new SQLite.Net.Platform.WinRT.SQLitePlatformWinRT(), sqlpath);

        public static void InitializeLocalDB()
        {
            CreateDatabase();
#if DEBUG
            LocalDatabaseHelper deleteAct = new LocalDatabaseHelper();
            deleteAct.DeleteActivity();
            LocalDatabaseHelper deleteCon = new LocalDatabaseHelper();
            deleteCon.DeleteContext();
            LocalDatabaseHelper deletePro = new LocalDatabaseHelper();
            deletePro.DeleteProject();
            //DeleteAllItemsInTable<Activity>();
            //DeleteAllItemsInTable(typeof(Activity));
            //DeleteAllItemsInTable(typeof(Context));
            //DeleteAllItemsInTable(typeof(Project));
